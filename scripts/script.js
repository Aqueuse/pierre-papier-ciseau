...
function updateStatsDisplay() {
  document.getElementById("stats").innerText =
    "Gagnés: " + stats.wins + " - Perdus: " + stats.losses + " - Égalités: " + stats.draws + " | Pierre: " + stats.pierre + " - Papier: " + stats.papier + " - Ciseau: " + stats.ciseau;
}
...
function play(userChoice) {
  ...
  resultElement.parentNode.insertBefore(countdownElement, resultElement);
  ...
  setTimeout(() => {
    ...
    if (userChoice === computerChoice) {
      result = "Égalité !";
      stats.draws++;
    } else if ((userChoice === "pierre" && computerChoice === "ciseau") || (userChoice === "papier" && computerChoice === "pierre") || (userChoice === "ciseau" && computerChoice === "papier")) {
      result = "Vous gagnez !";
      stats.wins++;
    } else {
      result = "Vous perdez !";
    ...
    document.getElementById("result").innerText = "Vous avez choisi " + userChoice + ", l'ordinateur a choisi " + computerChoice + ". " + result;
